		            ...
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
		                    ...
		                    <div class="switch" @click="show_list_product_information = !show_list_product_information">
		                        <div class="switch_box">
		                            <span v-if="show_list_product_information"> 切换表格 </span>
		                            <span v-else> 切换列表 </span>
		                        </div>
		                    </div>
		                </div>
		                ...
		                <div class="overflow-auto" v-else>
		                    <table id="list_diy" role="table" aria-busy="false"
		                        ...
		                        <tbody>
		                        <tr v-for="(o, i) in list_table_product_information" :key="i" @click="to_details('product_information',o,'product_information_id')">
...
<script>
	...
	export default {
		...
		computed: {
		    list_table_product_information() {
