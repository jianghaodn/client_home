		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','return_request_')">退货申请
					</th>
					<th class="diy_title" v-if="$check_field('get','collection_account_number')">收款账号
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','return_request_')">
						<span>
							{{ o["return_request_"] }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','collection_account_number')">
						<span>
							{{ o["collection_account_number"] }}
						</span>
					</td>
				</tr>
			</table>
